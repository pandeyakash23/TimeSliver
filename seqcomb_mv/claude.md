# TimeSliver - SeqComb-MV (Multivariate) Classification

This folder contains the TimeSliver implementation for **4-class classification on SeqComb Multivariate time series data**.
...
## Key Parameters (SeqComb-MV Specific)
...
| `LINEAR_INPUT` | 720 * max_m | Final layer input size |

## Architecture Details

### Model Architecture (SeqComb-MV)
```
Input (x) ─────────────────────────────────┐
    │                                      │
    ▼                                      │
...
```bash
cd /home/apa2237/TimeSliver/seqcomb_mv/main
...
- **d_model is data-dependent** - Automatically extracted from data feature dimension.
