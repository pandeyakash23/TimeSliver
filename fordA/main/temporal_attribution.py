"""
Calculate temporal attribution scores for time series samples.

This script computes per-time-point importance scores that identify
which parts of the time series are most relevant for the model's predictions.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Calculate temporal attribution scores",
