"""
Centralized configuration for TimeSliver - Audio Dataset.
...
D_OUT = 12      # Output dimension for CNN (d)
MAX_M = 1       # Number of motif scales
MAX_LEN = 501   # Maximum sequence length for positional encoding

# Linear layer input size: d_out * 133 * max_m
LINEAR_INPUT_MULTIPLIER = 133
...
# Masking training (different hyperparameters)
MASK_TRAIN_LR = 0.001
