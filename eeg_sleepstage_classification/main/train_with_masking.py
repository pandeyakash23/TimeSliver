...
def train(args):
    ...
    save_dict = {"num_classes": config.NUM_CLASSES, "q": args.d_model, "d": args.d_out, "max_m": args.max_m}
    ...
    if args.tensorboard and HAS_TENSORBOARD:
        comment = f"TimeSliver_EEG_masking_imp{args.method}_top{args.top_percent}"
        if args.sub_method:
