"""
Centralized configuration for TimeSliver - EEG Sleep Stage Classification.
...
INPUT_DIM = 1    # Single-channel EEG

# =============================================================================
# MODEL ARCHITECTURE
# =============================================================================
D_MODEL = 32    # Model dimension (q)
...
# Masking training (same hyperparameters for this dataset)
MASK_TRAIN_LR = 0.001
