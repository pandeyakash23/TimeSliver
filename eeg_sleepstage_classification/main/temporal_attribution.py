"""
Calculate temporal attribution scores for EEG sleep stage samples.

This script computes per-time-point importance scores that identify
which parts of the EEG signal are most relevant for the model's predictions.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Calculate temporal attribution scores for EEG data",
