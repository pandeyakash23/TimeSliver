"""
Train the TimeSliver model on Synthetic Data.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Train TimeSliver model for Synthetic Data classification",
...
def create_model(d_model, d_out, max_m, device):
    ...
    Args:
        d_model: Model dimension (from data feature size)
...
def train(args):
    ...
    if args.tensorboard and HAS_TENSORBOARD:
        writer = SummaryWriter(comment=f"TimeSliver_Synthetic_lr{args.lr}_epochs{args.epochs}")
